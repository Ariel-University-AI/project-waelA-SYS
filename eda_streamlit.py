...
# תקנות בנייה לפי סוג מבנה — מקור: תקנות משרד החקלאות, רישוי עסקים (לולים) תשמ"א-1981, פטור מהיתר תשע"ד-2014
# גובה_מקס (מ'), מרחק_מגורים_מין (מ'), מרחק_כביש_מין (מ'), שטח_פטור_מהיתר (מ"ר), שטח_מקס (מ"ר)
BUILDING_RULES = {
    "חממה":              {"גובה_מקס": 6.0,  "מרחק_מגורים_מין": 50,   "מרחק_כביש_מין": 30,  "שטח_פטור": 400},
    "רפת":               {"גובה_מקס": 8.0,  "מרחק_מגורים_מין": 500,  "מרחק_כביש_מין": 50,  "שטח_פטור": None},
    "לול":               {"גובה_מקס": 8.0,  "מרחק_מגורים_מין": 500,  "מרחק_כביש_מין": 30,  "שטח_פטור": None},
    "אורווה":            {"גובה_מקס": 8.0,  "מרחק_מגורים_מין": 300,  "מרחק_כביש_מין": 50,  "שטח_פטור": None},
    "כבשייה":            {"גובה_מקס": 6.0,  "מרחק_מגורים_מין": 200,  "מרחק_כביש_מין": 30,  "שטח_פטור": None},
    "יקב":               {"גובה_מקס": 10.0, "מרחק_מגורים_מין": 50,   "מרחק_כביש_מין": 50,  "שטח_מקס": 1000},
    "בית בד":            {"גובה_מקס": 8.0,  "מרחק_מגורים_מין": 50,   "מרחק_כביש_מין": 30,  "שטח_פטור": None},
    "סככת ציוד":         {"גובה_מקס": 4.5,  "מרחק_מגורים_מין": 30,   "מרחק_כביש_מין": 20,  "שטח_פטור": 400},
    "בית אריזה":         {"גובה_מקס": 8.0,  "מרחק_מגורים_מין": 50,   "מרחק_כביש_מין": 30,  "שטח_פטור": None},
    "בית אריזה פרחים":   {"גובה_מקס": 6.0,  "מרחק_מגורים_מין": 50,   "מרחק_כביש_מין": 30,  "שטח_פטור": 400},
    "בית אריזה תות שדה": {"גובה_מקס": 6.0,  "מרחק_מגורים_מין": 50,   "מרחק_כביש_מין": 30,  "שטח_פטור": 400},
    "חממת קנאביס רפואי": {"גובה_מקס": 6.0,  "מרחק_מגורים_מין": 200,  "מרחק_כביש_מין": 100, "שטח_מקס": 2000},
    "מחסן חקלאי":        {"גובה_מקס": 7.0,  "מרחק_מגורים_מין": 50,   "מרחק_כביש_מין": 20,  "שטח_פטור": 400},
    "מחסן קירור":        {"גובה_מקס": 8.0,  "מרחק_מגורים_מין": 50,   "מרחק_כביש_מין": 30,  "שטח_פטור": None},
    "מכון רדייה":        {"גובה_מקס": 6.0,  "מרחק_מגורים_מין": 100,  "מרחק_כביש_מין": 50,  "שטח_פטור": None},
}
